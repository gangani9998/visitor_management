...
def fix_print_format_employee_name():
    print_doc = frappe.get_doc("Print Format", "Visitor Gate Pass")
    
    # In Jinja templating for Frappe Print Formats, we can use frappe.db.get_value to fetch data dynamically!
    new_html = """
    ...
    frappe.clear_cache()
    print("Fixed Print Format Employee Name logic!")

if __name__ == "__main__":
    fix_print_format_employee_name()
